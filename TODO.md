...
Shared tracking across content and web. Updated April 2026.
...
- [x] Create `content/modules/` and move all 12 numbered module folders into it
...
- [ ] Create `bahai-modules-content` repo on GitHub — just the numbered module folders + a contributor README
- [ ] Write `content/modules/README.md` — writer-facing guide (module folder structure, draft versioning, where to put source material)
- [ ] Push current `content/modules/` content to the new repo
- [ ] Create a sync script (`scripts/sync-modules.sh`) to pull writer's changes into this monorepo
...
## Module Revisions (priority order from critical review)

### Tier 1 — Rewrite
- [ ] Module 11: Suffering and Justice — not a module (pasted letter). Rewrite using letter as source material.
- [ ] Module 12: Non-Involvement in Partisan Politics — not a module (pasted letter, 11 comprehension Qs). Rewrite.

### Tier 2 — Significant Revision
- [ ] Module 07: Making Sense of a Turbulent World — claims-as-fact, too long, labels atheism as "dark force"
- [ ] Module 04: Developing a Relationship with God — underdeveloped, 0 block quotes, no citations, Section 2 is a quote list

### Tier 3 — Moderate Revision
- [ ] Module 02: Baha'i Spiritual Principles — afterlife stated as flat fact, practices section reads as onboarding
- [ ] Module 05: The Bab and Baha'u'llah — hagiographic tone, 0 block quotes, no citations
- [ ] Module 06: Centers of the Covenant — no opening questions, UHJ gender issue dismissed

### Tier 4 — Polish
- [ ] Module 01: Overview of the Baha'i Faith — style guide cleanup, add citations
- [ ] Module 03: Baha'i Social Teachings — too long (~4200 words), consider splitting
...
## Editorial Cleanup (applies to all modules during revision)
...
- [ ] Add citations sections to all modules
